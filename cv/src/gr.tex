...
\newenvironment{jobReflectizLead}{%
    \begin{place}{Company Technical Lead}{Jan 2021 -- Present}{\reflectiz}{\ramatgan}
}{%
    \end{place}
}
...
\begin{sectionList}
    ...
    \begin{jobReflectizLead}
        ...
        \item Greatly expanded architecture of a Chromium-based platform$^\star$.
        \item Designed a data pipeline processing 100+ MB/sec of JSON-encoded graph data.
        \item Led deployment of system health and throughput metrics across 10+ services.
        \item Ported existing infrastructure to IaC, scaled by \texttimes30+, and expanded into new regions.
        \item Set code conventions and conducted code reviews across multiple codebases.
        \item Designed browser automation DSL and dev tools checked by the TypeScript compiler.
