\newcommand{\RefDistributed}{%
    \item Built a stateless, distributed system that scaled to 300+ concurrent automation jobs based on demand.
}%
...
\newcommand{\RefDesignedPlatform}{%
    \item Designed browser automation platform at the core of the product, in TypeScript on Node.js.
}%
...
\newcommand{\RefMicroservicesTools}{%
    \item Wrote micro-services and tools in Python and Bash for complex tasks, speeding up development.
}%
